...
def main():
    ...
    # User login with many attempts
    attempts = 3  # Reset the attempts count at the start
    user = None
    while attempts > 0:
        username = input("Enter username: ")
        password = input("Enter password: ")
    ...
    while True:
        ...
        if play_again.lower() != 'y':
            ...
            # Reset the attempts for next login if user chooses to play again
            attempts = 3  # Resetting attempts here
